    ...
    <div className="settings-wrapper">
      ...
      <div className="flex-table">
        <div className="flex-table-header">
          ...
          <span
            className="category sort-column"
            onClick={handleSort}
            column="OrgName">
            Organization
          ...
          {/* <span className="events-count sort-column" onClick={handleSort} column="TotalSupplier">
                      Suppliers Count
                      {
